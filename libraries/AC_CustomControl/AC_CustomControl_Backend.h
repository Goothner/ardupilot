...
{
public:
    AC_CustomControl_Backend(AC_CustomControl& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl*& att_control, /*AC_PosControl*& pos_control, */AP_MotorsMulticopter*& motors, float dt) :
        _frontend(frontend),
        _ahrs(ahrs),
