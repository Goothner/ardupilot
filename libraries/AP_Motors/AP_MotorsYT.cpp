...
void AP_MotorsYT::output_armed_stabilizing()
{
    ...
    float X_0;
    int32_t i_disabled = 3;
    // matrix of effectiveness 
    static float Matrix_E[80] = { -0.46432882F, -0.46432882F, -0.46432882F,-0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, 
        -0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, -0.4375310F, -0.4375310F, 
        -0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, -0.4375310F, -0.4375310F,

        -0.0734256F, -0.1316648F, -0.1433440F, -0.2015832F, 
        0.0734256F, 0.1316648F, 0.1433440F, 0.2015832F, 
        //-69.8434 -128.0816 -139.7597 -197.9978 -196.9447 -220.4905   
        //69.8434  128.0816  139.7597  197.9978  196.9447  220.4905
        -0.0698434F, -0.1280816F, -0.1397597F, -0.1979978F, -0.1969447F, -0.2204905F,
        0.0698434F, 0.1280816F, 0.1397597F, 0.1979978F, 0.1969447F, 0.2204905F,
        
        

        0.2091001F, 0.2088221F, 0.2085441F, 0.2082660F, 0.2091001F, 0.2088221F, 0.2085441F, 0.2082660F,
        -0.1614819F, -0.1612038F, -0.1609256F, -0.1606475F, -0.1510705F, -0.1507923F, 
        -0.1614819F, -0.1612038F, -0.1609256F, -0.1606475F, -0.1510705F, -0.1507923F, 

        -0.0260946F, -0.0292724F, -0.0324501F, -0.0356278F, 
        0.0260946F, 0.0292724F, 0.0324501F, 0.0356278F, 
        //-21.3139  -24.4915  -27.6691  -30.8468 -100.4748 -114.1028   
        // 21.3139   24.4915   27.6691   30.8468  100.4748  114.1028
        -0.0213139F, -0.0244915F, -0.0276691F, -0.0308468F, -0.1004748F, -0.1141028F,
         0.0213139F,  0.0244915F,  0.0276691F,  0.0308468F,  0.1004748F,  0.1141028F, };
    // motor 5 disabled
    Matrix_E[0+i_disabled] = 0.0F;
    Matrix_E[20+i_disabled] = 0.0F;
    Matrix_E[40+i_disabled] = 0.0F;
    Matrix_E[60+i_disabled] = 0.0F;
        // static const float A[80] = { 0.0F, -0.46432882F, -0.46432882F,-0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, 
        // -0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, -0.4375310F, -0.4375310F, 
        // -0.46432882F, -0.46432882F, -0.46432882F, -0.46432882F, -0.4375310F, -0.4375310F,

        // 0.0F, -0.1316648F, -0.1433440F, -0.2015832F, 
        // 0.0734256F, 0.1316648F, 0.1433440F, 0.2015832F, 
        // //-69.8434 -128.0816 -139.7597 -197.9978 -196.9447 -220.4905   
        // //69.8434  128.0816  139.7597  197.9978  196.9447  220.4905
        // -0.0698434F, -0.1280816F, -0.1397597F, -0.1979978F, -0.1969447F, -0.2204905F,
        ...
        // 0.0F, 0.2088221F, 0.2085441F, 0.2082660F, 0.2091001F, 0.2088221F, 0.2085441F, 0.2082660F,
        // -0.1614819F, -0.1612038F, -0.1609256F, -0.1606475F, -0.1510705F, -0.1507923F, 
        // -0.1614819F, -0.1612038F, -0.1609256F, -0.1606475F, -0.1510705F, -0.1507923F, 

        // 0.0F, -0.0292724F, -0.0324501F, -0.0356278F, 
        // 0.0260946F, 0.0292724F, 0.0324501F, 0.0356278F, 
        // //-21.3139  -24.4915  -27.6691  -30.8468 -100.4748 -114.1028   
        // // 21.3139   24.4915   27.6691   30.8468  100.4748  114.1028
        // -0.0213139F, -0.0244915F, -0.0276691F, -0.0308468F, -0.1004748F, -0.1141028F,
    ...
    // static const float A[80] = { -0.46432882, -0.46432882, -0.46432882,-0.46432882, -0.46432882, -0.46432882, -0.46432882, -0.46432882, 
    //     -0.4661, -0.4661, -0.4661, -0.4661, -0.4392, -0.4392, -0.4661, -0.4661, -0.4661, -0.4661, -0.4392, -0.4392,
    //     -0.0734256, -0.1346477, -0.1433440, -0.2015832, 0.0734256, 0.1346477, 0.1433440, 0.2015832, 
    //     -0.046622500000000004, -0.10486000000000001, -0.11653750000000003, -0.174775, -0.17501999999999998, -0.23124,
    //     0.046622500000000004, 0.10486000000000001, 0.11653750000000003, 0.174775, 0.17501999999999998, 0.23124, 
    //     0.2091001, 0.2088236, 0.2085441, 0.2082660, 0.2091001, 0.2088236, 0.2085441, 0.2082660,
    //     -0.1623746, -0.1623746, -0.1623746, -0.1623746, -0.1530403, -0.1530403, 
    //     -0.1623746, -0.1623746, -0.1623746, -0.1623746, -0.1530403, -0.1530403, 
    //     -0.025490536560000002, -0.028680286560000004, -0.03187003656, -0.03505978656, 
    //     0.025490536560000002, 0.028680286560000004, 0.03187003656, 0.03505978656, 
    //     -0.00531625, -0.008506, -0.011695750000000001, -0.014885499999999998, -0.07752, -0.0912,
    //     0.00531625, 0.008506, 0.011695750000000001, 0.014885499999999998, 0.07752, 0.0912 };

    // MATLAB Function: '<S1>/MATLAB Function'
    std::fill(X, X + 80, 0.0f);
    _svd(Matrix_E, U, rtb_VectorConcatenate, V);
    ...
    // Disabled signal
    rtb_Sqrt[i_disabled] = 0.0F;    // SignalConversion generated from: '<Root>/RPM2PWM'
