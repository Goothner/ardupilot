...
// void AP_MotorsYT::diag(const float* v, float* d)
// {
//   int j;
//   std::memset(&d[0], 0, 484U * sizeof(float));
//   for (j = 0; j < 22; j++) {
//     d[j + 22 * j] = v[j];
//   }
// }
...
void AP_MotorsYT::mldivide(const float* A, float* B)
{
  float temp;
  int ip;
  //float b_A[484];
  ...
  int k;
  int i;
  //std::memcpy(&b_A[0], &A[0], 484U * sizeof(float));
  std::memcpy(&_B_1[0], &_B_0[0], 484U * sizeof(float));
  xgetrf(_B_1, ipiv, &info);
  for (info = 0; info < 21; info++) {
    if (info + 1 != ipiv[info]) {
      ip = ipiv[info] - 1;
      temp = B[info];
      B[info] = B[ip];
  ...
  for (uint8_t j = 0; j < 4; j++) {
    ...
    for (k = 0; k < 22; k++) {
      kAcol = 22 * k;
      info = k + jBcol;
      if (!is_zero(B[info])) {//!is_zero() <==> B[info] != 0.0F
        for (i = k + 2; i < 23; i++) {
          ip = (i + jBcol) - 1;
          B[ip] -= _B_1[(i + kAcol) - 1] * B[info];
        }
      }
    }
  }
...
void AP_MotorsYT::xgetrf(float* A, int* ipiv, int *info)
{
  //int j;
  int c;
  int ix;
  ...
  *info = 0;
  for (uint8_t j = 0; j < 21; j++) {
    ...
    if (!is_zero(A[c + b_ix])) {//!is_zero() <==> A[c + b_ix] != 0.0F
      if (b_ix != 0) {
        ix = j + b_ix;
        ipiv[j] = ix + 1;
        b_ix = j;
    ...
    ix = c + 22;
    for (k = 0; k <= 20 - j; k++) {
      if (!is_zero(A[ix])) {//!is_zero() <==> b_A[ix] != 0.0F
        smax = -A[ix];
        c_ix = c + 1;
        d = (b_ix - j) + 44;
        for (ijA = b_ix + 23; ijA < d; ijA++) {
          A[ijA] += A[c_ix] * smax;
          c_ix++;
        }
      }
  ...
  if ((*info == 0) && is_zero(_B_0[483])) {//!is_zero() <==> A[483] != 0.0F
    *info = 22;
  }
}
...
// float AP_MotorsYT::xnrm2(int n, const float* x, int ix0)
// {
//   float y;
//   float scale;
//   int kend;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// float AP_MotorsYT::xnrm2_j(int n, const float* x, int ix0)
// {
//   float y;
//   float scale;
//   int kend;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xaxpy_m0(int n, float a, const float* x, int ix0, float* y, int iy0)
// {
//   int ix;
//   int iy;
//   int k;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xaxpy_m(int n, float a, const float* x, int ix0, float* y, int iy0)
// {
//   int ix;
//   int iy;
//   int k;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// float AP_MotorsYT::xdotc(int n, const float x[80], int ix0, const float y[80], int iy0)
// {
//   float d;
//   int ix;
//   int iy;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xaxpy(int n, float a, int ix0, float y[80], int iy0)
// {
//   int ix;
//   int iy;
//   int k;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// float AP_MotorsYT::xdotc_e(int n, const float x[16], int ix0,const float y[16], int iy0)
// {
//   float d;
//   int ix;
//   int iy;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xaxpy_m0a(int n, float a, int ix0, float y[16], int iy0)
// {
//   int ix;
//   int iy;
//   int k;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xscal(float a, float x[80], int ix0)
// {
//   int k;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xscal_c(float a, float x[16], int ix0)
// {
//   int k;
//   for (k = ix0; k <= ix0 + 3; k++) {
//     x[k - 1] *= a;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xswap(float x[16], int ix0, int iy0)
// {
//   int ix;
//   int iy;
//   float temp;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xswap_m(float x[80], int ix0, int iy0)
// {
//   int ix;
//   int iy;
//   float temp;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xrot(float x[16], int ix0, int iy0, float c, float s)
// {
//   int ix;
//   int iy;
//   float temp;
...
// // Function for MATLAB Function: '<S1>/MATLAB Function'
// void AP_MotorsYT::xrot_f(float x[80], int ix0, int iy0, float c, float s)
// {
//   int ix;
//   int iy;
//   float temp;
