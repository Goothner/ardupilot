...
typedef enum
{
    PKT_ESC_STATUS_A = 0x00,      //!< ESC Status A telemetry packet transmitted by the ESC at regular intervals
    PKT_ESC_STATUS_B = 0x02,             //!< ESC Status B telemetry packet transmitted by the ESC at regular intervals
